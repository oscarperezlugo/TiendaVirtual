...
async function getjson() {
    ...
    products = await fetch("https://paladarweb.somee.com/Api/api/Productoes", requestOptions)
...
function finButton() {
    ...
    finButton[0].addEventListener('click', () => {                
        ...
        Object.values(lineas).map((item, index) => {
            ...
            fetch("https://paladarweb.somee.com/Api/api/Lineas", requestOptions)
                .then(response => response.text())                                
                .catch(error => console.log('error', error))
        ...
        fetch("https://paladarweb.somee.com/Api/api/Cabeceras", requestOptions)
            .then(response => response.text())
...
function actCant() {
    ...
    Object.values(lineas).map((item, index) => {
        ...
        fetch("https://paladarweb.somee.com/Api/api/Cantidad", requestOptions)
            .then(response => response.text())
